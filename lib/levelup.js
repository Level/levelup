...
function LevelUP (location, options, callback) {
  ...
  this._active = 0 // number of active read/write operations
...
LevelUP.prototype._getCallback = function (options, callback) {
  var self = this
  self._active++
...
LevelUP.prototype.get = function (key_, options, callback) {
  ...
  callback = self._getCallback(options, callback)
