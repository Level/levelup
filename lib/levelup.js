...
var EventEmitter   = require('events').EventEmitter
  ...
  , createLevelUP = function (location, options, callback) {
      ...
      LevelUP.prototype.get = function (key_, options, callback) {
        ...
        options.asBuffer =  'object' ===typeof valueEnc 
          ? !!valueEnc.buffer 
          : valueEnc != 'utf8' && valueEnc != 'json'
        ...
        this.db.get(key, options, function (err, value) {
          ...
          if (callback) {
            try {
              value = (toEncoding[valueEnc || 'utf8'] || valueEnc.decode)(value)
            } catch (e) {
      ...
      LevelUP.prototype.put = function (key_, value_, options, callback) {
        ...
        options = getOptions(levelup, options)
        key     = (toSlice[options.keyEncoding] || options.keyEncoding.encode)(key_)
        value   = (toSlice[options.valueEncoding] || options.valueEncoding.encode)(value_)
      ...
      Batch.prototype.put = function (key_, value_, options) {
        options = getOptions(levelup, options)
        var key     = (toSlice[options.keyEncoding] || options.keyEncoding.encode)(key_)
//        key = toSlice[options.keyEncoding](key)
        var value   = (toSlice[options.valueEncoding] || options.valueEncoding.encode)(value_)
...
//        value   = (toSlice[options.valueEncoding] || options.valueEncoding.encode)(value_)
      ...
      LevelUP.prototype.batch = function (arr_, options, callback) {
        ...
        var arr = arr_.map(function (e) {
          ...
          if (kEnc != 'utf8' && kEnc != 'binary'
            ...
            o = {
              type: e.type,
              key: (toSlice[kEnc] || options.keyEncoding.encode)(e.key)
            }

            if (e.value !== undefined)
              o.value = (toSlice[vEnc] || options.valueEncoding.encode)(e.value)
      ...
      LevelUP.prototype.approximateSize = function (start_, end_, callback) {
        ...
        var start = (toSlice[options.keyEncoding || 'utf8'] || options.keyEncoding.encode)(start_)
        var end   = (toSlice[options.keyEncoding || 'utf8'] || options.keyEncoding.encode)(end_)
