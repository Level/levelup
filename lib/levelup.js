...
var EventEmitter   = require('events').EventEmitter
  ...
  , createLevelUP = function (location, options, callback) {
      ...
      LevelUP.prototype.open = function (callback) {
        dtrace['open-start'].fire(function () { return ([]) })
        var self = this
          , dbFactory
          , db
        ...
        if (isOpen()) {
          ...
          dtrace['open-done'].fire(function () { return ([]) })
          return self
        }
        ...
        db.open(levelup.options, function (err) {
          if (err) {
            ...
            dtrace['open-done'].fire(function () { return ([err.toString()]) })
      ...
      LevelUP.prototype.close = function (callback) {
        dtrace['close-start'].fire(function () { return ([]) })
        if (isOpen()) {
          status = 'closing'
          this.db.close(function () {
            ...
            dtrace['close-done'].fire(function () { return ([]) })
          })
      ...
      LevelUP.prototype.get = function (key_, options, callback) {
        dtrace['get-start'].fire(function () { return ([key_, options]) })
        var key
          , err
      ...
      LevelUP.prototype.put = function (key_, value_, options, callback) {
        dtrace['put-start'].fire(function () {
      ...
      LevelUP.prototype.del = function (key_, options, callback) {
        dtrace['del-start'].fire(function () { return ([key_, options]) })
        var err
          , key
      ...
      Batch.prototype.put = function (key_, value_, options) {
        dtrace['batchput-start'].fire(function () {
          return ([key_, value_, options])
        })
        options = getOptions(levelup, options)
        ...
        try {
          ...
          dtrace['batchput-done'].fire(function () {
      ...
      Batch.prototype.del = function (key_, options) {
        dtrace['batchdel-start'].fire(function () {
          return ([key_, options])
        })
        options = getOptions(levelup, options)
        var key     = util.encodeKey(key_, options)
        ...
        try {
          ...
          dtrace['batchdel-done'].fire(function () {
            return ([err.toString(), key_, options])
          })
      ...
      Batch.prototype.clear = function () {
        dtrace['batchclear-start'].fire(function () { return ([]) })
        try {
          this.batch.clear()
        } catch (err) {
          dtrace['batchclear-done'].fire(function () {
            return ([err.toString()])
          })
          throw new errors.WriteError(err)
        }
        ...
        this.ops = []
        dtrace['batchclear-done'].fire(function () { return ([]) })
        return this
      }

      Batch.prototype.write = function (callback) {
        var ops = this.ops
        dtrace['batchwrite-start'].fire(function() { return ([ops]) })
        try {
          this.batch.write(function (err) {
            if (err) {
              dtrace['batchwrite-done'].fire(function() {
      ...
      LevelUP.prototype.batch = function (arr_, options, callback) {
        dtrace['batchnew-start'].fire(function () {
          return ([arr_, options])
        })
        var keyEnc
          , valueEnc
        ...
        if (!arguments.length) {
          dtrace['batchnew-done'].fire(function () {
