...
var EventEmitter   = require('events').EventEmitter
  ...
  , createLevelUP = function (location, options, callback) {
      ...
      Batch.prototype.put = function (key, value, opts) {
        if (!opts) opts = {}
        var keyEncoding = opts.keyEncoding || 'utf8'
        if (keyEncoding != 'utf8') key = toSlice[keyEncoding](key)
        var valueEncoding = opts.valueEncoding || 'utf8'
        if (valueEncoding != 'utf8') value = toSlice[valueEncoding](key)
      ...
      Batch.prototype.write = function (callback) {
        ...
        this.batch.write(function (err) {
          if (err) return dispatchError(err, callback)
          levelup.emit('batch', this.ops)
      ...
      LevelUP.prototype.batch = function (arr, options, callback) {
        ...
        if (!arguments.length) return new Batch(this._db)
