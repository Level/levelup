...
LevelUP.prototype.close = function (callback) {
  ...
  if (this._activeOperations > 0) {
    this.once('inactive', this.close.bind(this, callback))
  } else if (this.isOpen()) {
...
function guardCallback (db, options, callback) {
  var callbackFunction = typeof options == 'function' ? options : callback
  if (typeof callbackFunction != 'function')
    return callbackFunction

  db._activeOperations++

  return function levelupCallback () {
    if (--db._activeOperations === 0)
      db.emit('inactive')
...
LevelUP.prototype.get = function (key_, options, callback) {
  ...
  callback = guardCallback(this, options, callback)
