...
var Readable      = require('readable-stream').Readable
  ...
  , makeKeyValueData = function (key, value) {
      return {
          key: this._codec.decodeKey(key, this._options)
        , value: this._codec.decodeValue(value, this._options)
      }
    }
  , makeKeyData = function (key) {
      return this._codec.decodeKey(key, this._options)
    }
  , makeValueData = function (_, value) {
      return this._codec.decodeValue(value, this._options)
    }
...
function ReadStream (options, db, iteratorFactory) {
  ...
  this._options.keyAsBuffer   = this._codec.isKeyAsBuffer(this._options)

  this._options.valueAsBuffer = this._codec.isValueAsBuffer(this._options)
