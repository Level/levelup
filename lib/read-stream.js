...
var Stream       = require('stream').Stream
  ...
  , makeKeyValueData = function (key, value) {
      return {
          key: (toEncoding[this._keyEncoding || 'utf8'] || this._keyEncoding.decode)(key)
        , value: (toEncoding[this._valueEncoding || 'utf8'] || this._valueEncoding.decode)(value)
      }
    }
  , makeKeyData = function (key) {
      return (toEncoding[this._keyEncoding || 'utf8'] || this._keyEncoding.decode)(key)
    }
  , makeValueData = function (key, value) {
      return (toEncoding[this._valueEncoding || 'uft8'] || this._valueEncoding.decode)(value)
    }
...
function ReadStream (options, db, iteratorFactory) {
  ...
  if (typeof this._options.start != 'undefined')
    this._options.start = (toSlice[this._keyEncoding || 'utf8'] || this._keyEncoding.encode)(this._options.start)
  if (typeof this._options.end != 'undefined')
    this._options.end = (toSlice[this._keyEncoding || 'utf8'] || this._keyEncoding.encode)(this._options.end)
  if (typeof this._options.limit != 'number')
    this._options.limit = -1
  this._options.keyAsBuffer   = 'object' === typeof this._keyEncoding
    ? !!this._keyEncoding.buffer 
    : this._keyEncoding != 'utf8'   && this._keyEncoding != 'json'

  this._options.valueAsBuffer = 'object' === typeof this._valueEncoding
